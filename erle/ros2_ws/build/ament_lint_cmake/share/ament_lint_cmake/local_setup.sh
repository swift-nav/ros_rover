...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ament_lint_cmake/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ament_lint_cmake/environment/pythonpath.sh"
