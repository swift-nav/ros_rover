...
#ifndef __stereo_msgs__msg__disparity_image__struct__hpp__
#define __stereo_msgs__msg__disparity_image__struct__hpp__
...
struct DisparityImage_
{
  ...
  Type * set__image(const sensor_msgs::msg::Image_<ContainerAllocator> & _arg)
  {
    this->image = _arg;
    return this;
  }
  Type * set__f(const float & _arg)
  {
    this->f = _arg;
    return this;
  }
  Type * set__t(const float & _arg)
  {
    this->t = _arg;
    return this;
  }
  Type * set__valid_window(const sensor_msgs::msg::RegionOfInterest_<ContainerAllocator> & _arg)
  {
    this->valid_window = _arg;
    return this;
  }
  Type * set__min_disparity(const float & _arg)
  {
    this->min_disparity = _arg;
    return this;
  }
  Type * set__max_disparity(const float & _arg)
  {
    this->max_disparity = _arg;
    return this;
  }
  Type * set__delta_d(const float & _arg)
  {
    this->delta_d = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<stereo_msgs::msg::DisparityImage_<ContainerAllocator>>>
...
#endif  // __stereo_msgs__msg__disparity_image__struct__hpp__
