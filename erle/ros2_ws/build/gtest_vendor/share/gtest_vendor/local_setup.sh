...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gtest_vendor/environment/path.sh:$AMENT_CURRENT_PREFIX/share/gtest_vendor/environment/library_path.sh"
