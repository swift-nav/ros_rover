...
#ifndef __std_srvs__srv__empty__request__struct__hpp__
#define __std_srvs__srv__empty__request__struct__hpp__
...
struct Empty_Request_
{
  ...
  Empty_Request_(const ContainerAllocator & _alloc)
  {
    (void)_alloc;
  }
  ...
  template<typename Deleter = std::default_delete<std_srvs::srv::Empty_Request_<ContainerAllocator>>>
...
#endif  // __std_srvs__srv__empty__request__struct__hpp__
