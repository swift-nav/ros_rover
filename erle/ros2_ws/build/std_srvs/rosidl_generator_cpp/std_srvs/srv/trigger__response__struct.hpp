...
#ifndef __std_srvs__srv__trigger__response__struct__hpp__
#define __std_srvs__srv__trigger__response__struct__hpp__
...
struct Trigger_Response_
{
  ...
  Trigger_Response_(const ContainerAllocator & _alloc)
  {
    (void)_alloc;
  }
  ...
  Type * set__message(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
    this->message = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_srvs::srv::Trigger_Response_<ContainerAllocator>>>
...
#endif  // __std_srvs__srv__trigger__response__struct__hpp__
