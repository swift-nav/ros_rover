...
#include "std_srvs/srv/dds_opensplice/ccpp_Sample_Trigger_Request_.h"
#include "std_srvs/srv/dds_opensplice/ccpp_Sample_Trigger_Response_.h"
...
template <>
class Sample<std_srvs::srv::dds_::Trigger_Request_> :
public std_srvs::srv::dds_::Sample_Trigger_Request_
{
public:

  std_srvs::srv::dds_::Trigger_Request_ & data() {
    
    return request_;
    
  }

  operator std_srvs::srv::dds_::Trigger_Request_() {
    return reinterpret_cast<std_srvs::srv::dds_::Trigger_Request_ &>(*this);
  }
};

template <>
class TemplateDataReader<std_srvs::srv::dds_::Sample_Trigger_Request_>
: public std_srvs::srv::dds_::Sample_Trigger_Request_DataReader
{
public:

  static const char * take_sample(
    DDS::DataReader* datareader,
    Sample<std_srvs::srv::dds_::Trigger_Request_> & sample,
    bool * taken)
  noexcept
  {
    std_srvs::srv::dds_::Sample_Trigger_Request_DataReader * typed_datareader = _narrow(datareader);

    std_srvs::srv::dds_::Sample_Trigger_Request_Seq dds_messages;
    ...
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataReader.take failed with: "
               "an internal error has occurred";
      case DDS::RETCODE_ALREADY_DELETED:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataReader.take failed with: "
               "this std_srvs::srv::dds_::Sample_Trigger_Request_DataReader has already been deleted";
      case DDS::RETCODE_OUT_OF_RESOURCES:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataReader.take failed with: "
               "out of resources";
      case DDS::RETCODE_NOT_ENABLED:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataReader.take failed with: "
               "this std_srvs::srv::dds_::Sample_Trigger_Request_DataReader is not enabled";
    ...
    if (sample_infos.length() > 0 && sample_infos[0].valid_data) {
      sample = reinterpret_cast<Sample<std_srvs::srv::dds_::Trigger_Request_> &>(dds_messages[0]);
      status = typed_datareader->return_loan(dds_messages, sample_infos);
      switch (status) {
        case DDS::RETCODE_ERROR:
          return "std_srvs::srv::dds_::Sample_Trigger_Request_DataReader.return_loan failed with: "
                 "an internal error has occurred";
        case DDS::RETCODE_ALREADY_DELETED:
          return "std_srvs::srv::dds_::Sample_Trigger_Request_DataReader.return_loan failed with: "
                 "this std_srvs::srv::dds_::Sample_Trigger_Request_DataReader has already been deleted";
        ...
        case DDS::RETCODE_PRECONDITION_NOT_MET:
          return "std_srvs::srv::dds_::Sample_Trigger_Request_DataReader.return_loan failed with: "
                 ...
                 "std_srvs::srv::dds_::Sample_Trigger_Request_DataReader";
        case DDS::RETCODE_OK:
          *taken = true;
          return nullptr;
        default:
...
template <>
class TemplateDataReader<Sample<std_srvs::srv::dds_::Trigger_Request_>>
: public TemplateDataReader<std_srvs::srv::dds_::Sample_Trigger_Request_>
{};

template <>
class TemplateDataWriter<std_srvs::srv::dds_::Sample_Trigger_Request_>
: public std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter
{
public:
  ...
  noexcept
  {
    std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter* typed_datawriter = _narrow(datawriter);

    DDS::ReturnCode_t status = typed_datawriter->write(sample, DDS::HANDLE_NIL);
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter.write: "
               "an internal error has occurred";
      ...
      case DDS::RETCODE_ALREADY_DELETED:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter.write: "
               "this std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter has already been deleted";
      case DDS::RETCODE_OUT_OF_RESOURCES:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter.write: "
               "out of resources";
      case DDS::RETCODE_NOT_ENABLED:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter.write: "
               "this std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter is not enabled";
      case DDS::RETCODE_PRECONDITION_NOT_MET:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter.write: "
               "the handle has not been registered with this "
               "std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter";
      ...
      case DDS::RETCODE_OK:
        return nullptr;
      default:
        return "std_srvs::srv::dds_::Sample_Trigger_Request_DataWriter.write: unknown return code";
    }
  }
};

template <>
class TemplateDataWriter<Sample<std_srvs::srv::dds_::Trigger_Request_>>
: public TemplateDataWriter<std_srvs::srv::dds_::Sample_Trigger_Request_>
{};



template <>
class Sample<std_srvs::srv::dds_::Trigger_Response_> :
public std_srvs::srv::dds_::Sample_Trigger_Response_
{
public:

  std_srvs::srv::dds_::Trigger_Response_ & data() {
    
    return response_;
    
  }

  operator std_srvs::srv::dds_::Trigger_Response_() {
    return reinterpret_cast<std_srvs::srv::dds_::Trigger_Response_ &>(*this);
  }
};

template <>
class TemplateDataReader<std_srvs::srv::dds_::Sample_Trigger_Response_>
: public std_srvs::srv::dds_::Sample_Trigger_Response_DataReader
{
public:

  static const char * take_sample(
    DDS::DataReader* datareader,
    Sample<std_srvs::srv::dds_::Trigger_Response_> & sample,
    bool * taken)
  noexcept
  {
    std_srvs::srv::dds_::Sample_Trigger_Response_DataReader * typed_datareader = _narrow(datareader);

    std_srvs::srv::dds_::Sample_Trigger_Response_Seq dds_messages;
    DDS::SampleInfoSeq sample_infos;
    DDS::ReturnCode_t status = typed_datareader->take(
      dds_messages,
      sample_infos,
    ...
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataReader.take failed with: "
               "an internal error has occurred";
      case DDS::RETCODE_ALREADY_DELETED:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataReader.take failed with: "
               "this std_srvs::srv::dds_::Sample_Trigger_Response_DataReader has already been deleted";
      case DDS::RETCODE_OUT_OF_RESOURCES:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataReader.take failed with: "
               "out of resources";
      case DDS::RETCODE_NOT_ENABLED:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataReader.take failed with: "
               "this std_srvs::srv::dds_::Sample_Trigger_Response_DataReader is not enabled";
      case DDS::RETCODE_PRECONDITION_NOT_MET:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataReader.take failed with: "
               "a precondition is not met, one of: "
               "max_samples > maximum and max_samples != LENGTH_UNLIMITED, or "
    ...
    if (sample_infos.length() > 0 && sample_infos[0].valid_data) {
      sample = reinterpret_cast<Sample<std_srvs::srv::dds_::Trigger_Response_> &>(dds_messages[0]);
      status = typed_datareader->return_loan(dds_messages, sample_infos);
      switch (status) {
        case DDS::RETCODE_ERROR:
          return "std_srvs::srv::dds_::Sample_Trigger_Response_DataReader.return_loan failed with: "
                 "an internal error has occurred";
        case DDS::RETCODE_ALREADY_DELETED:
          return "std_srvs::srv::dds_::Sample_Trigger_Response_DataReader.return_loan failed with: "
                 "this std_srvs::srv::dds_::Sample_Trigger_Response_DataReader has already been deleted";
        ...
        case DDS::RETCODE_PRECONDITION_NOT_MET:
          return "std_srvs::srv::dds_::Sample_Trigger_Response_DataReader.return_loan failed with: "
                 ...
                 "the data_values and info_seq do not belong to a single related pair, or "
                 "the data_values and info_seq were not obtained from this "
                 "std_srvs::srv::dds_::Sample_Trigger_Response_DataReader";
        case DDS::RETCODE_OK:
          *taken = true;
          return nullptr;
        default:
...
template <>
class TemplateDataReader<Sample<std_srvs::srv::dds_::Trigger_Response_>>
: public TemplateDataReader<std_srvs::srv::dds_::Sample_Trigger_Response_>
{};

template <>
class TemplateDataWriter<std_srvs::srv::dds_::Sample_Trigger_Response_>
: public std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter
{
public:
  ...
  noexcept
  {
    std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter* typed_datawriter = _narrow(datawriter);

    DDS::ReturnCode_t status = typed_datawriter->write(sample, DDS::HANDLE_NIL);
    switch (status) {
      case DDS::RETCODE_ERROR:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter.write: "
               "an internal error has occurred";
      case DDS::RETCODE_BAD_PARAMETER:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter.write: "
               "bad handle or instance_data parameter";
      case DDS::RETCODE_ALREADY_DELETED:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter.write: "
               "this std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter has already been deleted";
      case DDS::RETCODE_OUT_OF_RESOURCES:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter.write: "
               "out of resources";
      case DDS::RETCODE_NOT_ENABLED:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter.write: "
               "this std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter is not enabled";
      case DDS::RETCODE_PRECONDITION_NOT_MET:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter.write: "
               "the handle has not been registered with this "
               "std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter";
      case DDS::RETCODE_TIMEOUT:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter.write: "
               "writing resulted in blocking and then exceeded the timeout set by the "
               "max_blocking_time of the ReliabilityQosPolicy";
      case DDS::RETCODE_OK:
        return nullptr;
      default:
        return "std_srvs::srv::dds_::Sample_Trigger_Response_DataWriter.write: unknown return code";
    }
  }
};

template <>
class TemplateDataWriter<Sample<std_srvs::srv::dds_::Trigger_Response_>>
: public TemplateDataWriter<std_srvs::srv::dds_::Sample_Trigger_Response_>
{};
  ...
  void * untyped_participant, const char * request_type_name, const char * response_type_name)
{
  ...
  std_srvs::srv::dds_::Sample_Trigger_Request_TypeSupport ros_request_ts;
  DDS::ReturnCode_t status = ros_request_ts.register_type(participant, request_type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_srvs::srv::dds_::Sample_Trigger_Request_TypeSupport.register_type: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "std_srvs::srv::dds_::Sample_Trigger_Request_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      return "std_srvs::srv::dds_::Sample_Trigger_Request_TypeSupport.register_type: unkown return code";
  }

  std_srvs::srv::dds_::Sample_Trigger_Response_TypeSupport ros_response_ts;
  status = ros_response_ts.register_type(participant, response_type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_srvs::srv::dds_::Sample_Trigger_Response_TypeSupport.register_type: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "std_srvs::srv::dds_::Sample_Trigger_Response_TypeSupport.register_type: "
             "bad domain participant or type name parameter";
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      return "std_srvs::srv::dds_::Sample_Trigger_Response_TypeSupport.register_type: unkown return code";
  }
  return nullptr;
}
  ...
  void * (* allocator)(size_t))
{
  ...
  const std::string service_type_name("std_srvs::srv::dds_::Sample_Trigger");
  const std::string request_type_name("std_srvs::srv::dds_::Sample_Trigger_Request_");
  const std::string response_type_name("std_srvs::srv::dds_::Sample_Trigger_Response_");
  ...
  const char * error_string = register_types__Trigger(
...
{
  using SampleT = rosidl_typesupport_opensplice_cpp::Sample<std_srvs::srv::dds_::Trigger_Request_>;
  using ROSRequestT = std_srvs::srv::Trigger_Request;
  ...
  bool * taken)
{
  ...
  rosidl_typesupport_opensplice_cpp::Sample<std_srvs::srv::dds_::Trigger_Request_> request;
...
{
  using ROSResponseT = std_srvs::srv::Trigger_Response;
  rosidl_typesupport_opensplice_cpp::Sample<std_srvs::srv::dds_::Trigger_Response_> response;
...
const char *
destroy_requester__Trigger(void * untyped_requester, void (* deallocator)(void *))
{
  using RequesterT = rosidl_typesupport_opensplice_cpp::Requester<
    std_srvs::srv::dds_::Trigger_Request_,
    std_srvs::srv::dds_::Trigger_Response_
...
const char *
destroy_responder__Trigger(void * untyped_responder, void (* deallocator)(void *))
{
  using ResponderT = rosidl_typesupport_opensplice_cpp::Responder<
    std_srvs::srv::dds_::Trigger_Request_,
    std_srvs::srv::dds_::Trigger_Response_
...
get_service_type_support_handle_opensplice<std_srvs::srv::Trigger>()
{
