...
extern const char * __std_srvs_srv_dds__Sample_Trigger_Request___keys (void);
extern const char * __std_srvs_srv_dds__Sample_Trigger_Request___name (void);
struct _std_srvs_srv_dds__Sample_Trigger_Request_ ;
extern  c_bool __std_srvs_srv_dds__Sample_Trigger_Request___copyIn(c_base base, struct std_srvs::srv::dds_::Sample_Trigger_Request_ *from, struct _std_srvs_srv_dds__Sample_Trigger_Request_ *to);
extern  void __std_srvs_srv_dds__Sample_Trigger_Request___copyOut(void *_from, void *_to);
struct _std_srvs_srv_dds__Sample_Trigger_Request_ {
