...
#ifndef __nav_msgs__srv__get_map__response__type_support__h__
#define __nav_msgs__srv__get_map__response__type_support__h__
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetMap_Response_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle_introspection<nav_msgs::msg::OccupancyGrid>(),  // members of sub message
    false,  // is array
    0,  // array size
...
get_message_type_support_handle_introspection<nav_msgs::srv::GetMap_Response>()
{
...
#endif  // __nav_msgs__srv__get_map__response__type_support__h__
