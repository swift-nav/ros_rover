...
#ifndef __nav_msgs__msg__grid_cells__struct__hpp__
#define __nav_msgs__msg__grid_cells__struct__hpp__
...
struct GridCells_
{
  ...
  Type * set__cell_width(const float & _arg)
  {
    this->cell_width = _arg;
    return this;
  }
  Type * set__cell_height(const float & _arg)
  {
    this->cell_height = _arg;
    return this;
  }
  Type * set__cells(const std::vector<geometry_msgs::msg::Point_<ContainerAllocator>, typename ContainerAllocator::template rebind<geometry_msgs::msg::Point_<ContainerAllocator>>::other> & _arg)
  {
    this->cells = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<nav_msgs::msg::GridCells_<ContainerAllocator>>>
...
#endif  // __nav_msgs__msg__grid_cells__struct__hpp__
