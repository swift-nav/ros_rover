...
#ifndef __nav_msgs__msg__map_meta_data__struct__hpp__
#define __nav_msgs__msg__map_meta_data__struct__hpp__
...
#ifndef _WIN32
# define DEPRECATED_nav_msgs_msg_MapMetaData __attribute__((deprecated))
#else
# define DEPRECATED_nav_msgs_msg_MapMetaData __declspec(deprecated)
#endif
...
struct MapMetaData_
{
  ...
  Type * set__map_load_time(const builtin_interfaces::msg::Time_<ContainerAllocator> & _arg)
  {
    this->map_load_time = _arg;
    return this;
  }
  Type * set__resolution(const float & _arg)
  {
  ...
  Type * set__origin(const geometry_msgs::msg::Pose_<ContainerAllocator> & _arg)
  {
    this->origin = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<nav_msgs::msg::MapMetaData_<ContainerAllocator>>>
  ...
  typedef DEPRECATED_nav_msgs_msg_MapMetaData
    std::shared_ptr<nav_msgs::msg::MapMetaData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_nav_msgs_msg_MapMetaData
    std::shared_ptr<nav_msgs::msg::MapMetaData_<ContainerAllocator> const>
...
#endif  // __nav_msgs__msg__map_meta_data__struct__hpp__
