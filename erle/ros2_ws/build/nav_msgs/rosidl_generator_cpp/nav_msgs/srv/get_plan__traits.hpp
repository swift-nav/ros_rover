...
#ifndef __nav_msgs__srv__get_plan__traits__hpp__
#define __nav_msgs__srv__get_plan__traits__hpp__
template <>
struct has_fixed_size<nav_msgs::srv::GetPlan>
{
  static const bool value = has_fixed_size<nav_msgs::srv::GetPlan_Request>::value
    && has_fixed_size<nav_msgs::srv::GetPlan_Response>::value;
};

#endif  // __nav_msgs__srv__get_plan__traits__hpp__
