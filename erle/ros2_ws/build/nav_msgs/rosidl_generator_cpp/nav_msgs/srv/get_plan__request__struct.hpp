...
#ifndef __nav_msgs__srv__get_plan__request__struct__hpp__
#define __nav_msgs__srv__get_plan__request__struct__hpp__
...
struct GetPlan_Request_
{
  ...
  GetPlan_Request_(const ContainerAllocator & _alloc)
  {
    (void)_alloc;
  }
  ...
  Type * set__start(const geometry_msgs::msg::PoseStamped_<ContainerAllocator> & _arg)
  {
    this->start = _arg;
    return this;
  }
  Type * set__goal(const geometry_msgs::msg::PoseStamped_<ContainerAllocator> & _arg)
  {
    this->goal = _arg;
    return this;
  }
  Type * set__tolerance(const float & _arg)
  {
    this->tolerance = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<nav_msgs::srv::GetPlan_Request_<ContainerAllocator>>>
...
#endif  // __nav_msgs__srv__get_plan__request__struct__hpp__
