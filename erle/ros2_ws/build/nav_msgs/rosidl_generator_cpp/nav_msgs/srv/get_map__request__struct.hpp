...
#ifndef __nav_msgs__srv__get_map__request__struct__hpp__
#define __nav_msgs__srv__get_map__request__struct__hpp__
...
struct GetMap_Request_
{
  ...
  GetMap_Request_(const ContainerAllocator & _alloc)
  {
    (void)_alloc;
  }
  ...
  template<typename Deleter = std::default_delete<nav_msgs::srv::GetMap_Request_<ContainerAllocator>>>
...
#endif  // __nav_msgs__srv__get_map__request__struct__hpp__
