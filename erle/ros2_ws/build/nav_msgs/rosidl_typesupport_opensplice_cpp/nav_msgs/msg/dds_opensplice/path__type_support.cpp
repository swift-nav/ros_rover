...
#include "nav_msgs/msg/dds_opensplice/path__type_support.hpp"
...
using __dds_msg_type = nav_msgs::msg::dds_::Path_;
using __ros_msg_type = nav_msgs::msg::Path;
  ...
  const char * type_name)
{
  ...
  nav_msgs::msg::dds_::Path_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "nav_msgs::msg::dds_::Path_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "nav_msgs::msg::dds_::Path_TypeSupport.register_type: unknown return code";
  }
}
  ...
  const void * untyped_ros_message)
{
  ...
  nav_msgs::msg::dds_::Path_DataWriter * data_writer =
    nav_msgs::msg::dds_::Path_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "nav_msgs::msg::dds_::Path_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "nav_msgs::msg::dds_::Path_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "nav_msgs::msg::dds_::Path_DataWriter.write: "
             "this nav_msgs::msg::dds_::Path_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "nav_msgs::msg::dds_::Path_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "nav_msgs::msg::dds_::Path_DataWriter.write: "
             "this nav_msgs::msg::dds_::Path_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "nav_msgs::msg::dds_::Path_DataWriter.write: "
             "the handle has not been registered with this nav_msgs::msg::dds_::Path_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "nav_msgs::msg::dds_::Path_DataWriter.write: unknown return code";
  }
}
  ...
  void * sending_publication_handle)
{
  ...
  nav_msgs::msg::dds_::Path_DataReader * data_reader =
    nav_msgs::msg::dds_::Path_DataReader::_narrow(topic_reader);

  nav_msgs::msg::dds_::Path_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "nav_msgs::msg::dds_::Path_DataReader.take: "
             "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "nav_msgs::msg::dds_::Path_DataReader.take: "
             "this nav_msgs::msg::dds_::Path_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "nav_msgs::msg::dds_::Path_DataReader.take: "
             "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "nav_msgs::msg::dds_::Path_DataReader.take: "
             "this nav_msgs::msg::dds_::Path_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "nav_msgs::msg::dds_::Path_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "nav_msgs::msg::dds_::Path_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "nav_msgs::msg::dds_::Path_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "nav_msgs::msg::dds_::Path_DataReader.return_loan: "
             "this nav_msgs::msg::dds_::Path_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "nav_msgs::msg::dds_::Path_DataReader.return_loan: "
             ...
             "nav_msgs::msg::dds_::Path_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "nav_msgs::msg::dds_::Path_DataReader.return_loan failed with "
             "unknown return code";
  }
