...
#include "nav_msgs/msg/dds_opensplice/grid_cells__type_support.hpp"
...
using __dds_msg_type = nav_msgs::msg::dds_::GridCells_;
using __ros_msg_type = nav_msgs::msg::GridCells;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_nav_msgs
const char *
register_type__GridCells(
  ...
  const char * type_name)
{
  ...
  nav_msgs::msg::dds_::GridCells_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "nav_msgs::msg::dds_::GridCells_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "nav_msgs::msg::dds_::GridCells_TypeSupport.register_type: unknown return code";
  }
}
...
convert_ros_message_to_dds(const __ros_msg_type & ros_message, __dds_msg_type & dds_message)
{
  ...
  dds_message.cell_width_ = ros_message.cell_width;

  // field.name cell_height
  dds_message.cell_height_ = ros_message.cell_height;
  ...
  const void * untyped_ros_message)
{
  ...
  nav_msgs::msg::dds_::GridCells_DataWriter * data_writer =
    nav_msgs::msg::dds_::GridCells_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "nav_msgs::msg::dds_::GridCells_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "nav_msgs::msg::dds_::GridCells_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "nav_msgs::msg::dds_::GridCells_DataWriter.write: "
             "this nav_msgs::msg::dds_::GridCells_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "nav_msgs::msg::dds_::GridCells_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "nav_msgs::msg::dds_::GridCells_DataWriter.write: "
             "this nav_msgs::msg::dds_::GridCells_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "nav_msgs::msg::dds_::GridCells_DataWriter.write: "
             "the handle has not been registered with this nav_msgs::msg::dds_::GridCells_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "nav_msgs::msg::dds_::GridCells_DataWriter.write: unknown return code";
  }
}
...
convert_dds_message_to_ros(const __dds_msg_type & dds_message, __ros_msg_type & ros_message)
{
  ...
  // field.name cell_width
  ros_message.cell_width =
    dds_message.cell_width_;

  // field.name cell_height
  ros_message.cell_height =
    dds_message.cell_height_;

  // field.name cells
  {
    size_t size = dds_message.cells_.length();
    ros_message.cells.resize(size);
    for (DDS::ULong i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_opensplice_cpp::convert_dds_message_to_ros(
        dds_message.cells_[i], ros_message.cells[i]);
    }
  }
  ...
  void * sending_publication_handle)
{
  ...
  nav_msgs::msg::dds_::GridCells_DataReader * data_reader =
    nav_msgs::msg::dds_::GridCells_DataReader::_narrow(topic_reader);

  nav_msgs::msg::dds_::GridCells_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "nav_msgs::msg::dds_::GridCells_DataReader.take: "
             "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "nav_msgs::msg::dds_::GridCells_DataReader.take: "
             "this nav_msgs::msg::dds_::GridCells_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "nav_msgs::msg::dds_::GridCells_DataReader.take: "
             "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "nav_msgs::msg::dds_::GridCells_DataReader.take: "
             "this nav_msgs::msg::dds_::GridCells_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "nav_msgs::msg::dds_::GridCells_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "nav_msgs::msg::dds_::GridCells_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "nav_msgs::msg::dds_::GridCells_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "nav_msgs::msg::dds_::GridCells_DataReader.return_loan: "
             "this nav_msgs::msg::dds_::GridCells_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "nav_msgs::msg::dds_::GridCells_DataReader.return_loan: "
             ...
             "nav_msgs::msg::dds_::GridCells_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "nav_msgs::msg::dds_::GridCells_DataReader.return_loan failed with "
             "unknown return code";
  }
