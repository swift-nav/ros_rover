...
#ifndef STD_MSGS_STD_MSGS__MSG__UINT8MULTIARRAY__STRUCT_H_
#define STD_MSGS_STD_MSGS__MSG__UINT8MULTIARRAY__STRUCT_H_
...
ROSIDL_GENERATE_ARRAY(std_msgs__msg__UInt8MultiArray);

#endif  // STD_MSGS_STD_MSGS__MSG__UINT8MULTIARRAY__STRUCT_H_
