...
#ifndef STD_MSGS_STD_MSGS__MSG__INT8MULTIARRAY__STRUCT_H_
#define STD_MSGS_STD_MSGS__MSG__INT8MULTIARRAY__STRUCT_H_
...
ROSIDL_GENERATE_ARRAY(std_msgs__msg__Int8MultiArray);

#endif  // STD_MSGS_STD_MSGS__MSG__INT8MULTIARRAY__STRUCT_H_
