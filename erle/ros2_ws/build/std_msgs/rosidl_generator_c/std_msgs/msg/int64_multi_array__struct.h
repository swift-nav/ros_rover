...
#ifndef STD_MSGS_STD_MSGS__MSG__INT64MULTIARRAY__STRUCT_H_
#define STD_MSGS_STD_MSGS__MSG__INT64MULTIARRAY__STRUCT_H_
...
typedef struct std_msgs__msg__Int64MultiArray
{
  ...
  ROSIDL_Array__int64 data;
} std_msgs__msg__Int64MultiArray;

// constants

// symbols for arrays of the message type
ROSIDL_GENERATE_ARRAY(std_msgs__msg__Int64MultiArray);

#endif  // STD_MSGS_STD_MSGS__MSG__INT64MULTIARRAY__STRUCT_H_
