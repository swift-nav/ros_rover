...
#ifndef __std_msgs__msg__float32__struct__hpp__
#define __std_msgs__msg__float32__struct__hpp__
...
struct Float32_
{
  ...
  Type * set__data(const float & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Float32_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__float32__struct__hpp__
