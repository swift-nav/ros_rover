...
#ifndef __std_msgs__msg__float64_multi_array__struct__hpp__
#define __std_msgs__msg__float64_multi_array__struct__hpp__
...
struct Float64MultiArray_
{
  ...
  Type * set__data(const std::vector<double, typename ContainerAllocator::template rebind<double>::other> & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Float64MultiArray_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__float64_multi_array__struct__hpp__
