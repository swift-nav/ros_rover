...
#ifndef __std_msgs__msg__color_rgba__struct__hpp__
#define __std_msgs__msg__color_rgba__struct__hpp__
...
struct ColorRGBA_
{
  ...
  Type * set__r(const float & _arg)
  {
    this->r = _arg;
    return this;
  }
  Type * set__g(const float & _arg)
  {
    this->g = _arg;
    return this;
  }
  Type * set__b(const float & _arg)
  {
    this->b = _arg;
    return this;
  }
  Type * set__a(const float & _arg)
  {
    this->a = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::ColorRGBA_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__color_rgba__struct__hpp__
