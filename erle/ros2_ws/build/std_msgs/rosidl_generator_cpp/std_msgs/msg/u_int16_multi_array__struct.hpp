...
#ifndef __std_msgs__msg__u_int16_multi_array__struct__hpp__
#define __std_msgs__msg__u_int16_multi_array__struct__hpp__
...
struct UInt16MultiArray_
{
  ...
  Type * set__data(const std::vector<uint16_t, typename ContainerAllocator::template rebind<uint16_t>::other> & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::UInt16MultiArray_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__u_int16_multi_array__struct__hpp__
