...
#ifndef __std_msgs__msg__int16__struct__hpp__
#define __std_msgs__msg__int16__struct__hpp__
...
struct Int16_
{
  ...
  Type * set__data(const int16_t & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Int16_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__int16__struct__hpp__
