...
#ifndef __std_msgs__msg__int64__struct__hpp__
#define __std_msgs__msg__int64__struct__hpp__
...
struct Int64_
{
  ...
  Type * set__data(const int64_t & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Int64_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__int64__struct__hpp__
