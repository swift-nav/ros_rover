...
#ifndef __std_msgs__msg__float64__struct__hpp__
#define __std_msgs__msg__float64__struct__hpp__
...
struct Float64_
{
  ...
  Type * set__data(const double & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Float64_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__float64__struct__hpp__
