...
#ifndef __std_msgs__msg__u_int16__struct__hpp__
#define __std_msgs__msg__u_int16__struct__hpp__
...
struct UInt16_
{
  ...
  Type * set__data(const uint16_t & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::UInt16_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__u_int16__struct__hpp__
