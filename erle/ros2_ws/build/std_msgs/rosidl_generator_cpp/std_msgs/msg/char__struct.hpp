...
#ifndef __std_msgs__msg__char__struct__hpp__
#define __std_msgs__msg__char__struct__hpp__
...
struct Char_
{
  ...
  Type * set__data(const char & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Char_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__char__struct__hpp__
