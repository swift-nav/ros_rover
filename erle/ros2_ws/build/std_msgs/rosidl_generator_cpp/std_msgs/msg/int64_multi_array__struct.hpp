...
#ifndef __std_msgs__msg__int64_multi_array__struct__hpp__
#define __std_msgs__msg__int64_multi_array__struct__hpp__
...
struct Int64MultiArray_
{
  ...
  Type * set__data(const std::vector<int64_t, typename ContainerAllocator::template rebind<int64_t>::other> & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Int64MultiArray_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__int64_multi_array__struct__hpp__
