...
#ifndef __std_msgs__msg__int16_multi_array__struct__hpp__
#define __std_msgs__msg__int16_multi_array__struct__hpp__
...
struct Int16MultiArray_
{
  ...
  Type * set__data(const std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other> & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Int16MultiArray_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__int16_multi_array__struct__hpp__
