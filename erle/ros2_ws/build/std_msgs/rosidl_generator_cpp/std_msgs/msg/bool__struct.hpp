...
#ifndef __std_msgs__msg__bool__struct__hpp__
#define __std_msgs__msg__bool__struct__hpp__
...
struct Bool_
{
  ...
  Type * set__data(const bool & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Bool_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__bool__struct__hpp__
