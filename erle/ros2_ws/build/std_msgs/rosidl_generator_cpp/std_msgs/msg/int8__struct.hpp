...
#ifndef __std_msgs__msg__int8__struct__hpp__
#define __std_msgs__msg__int8__struct__hpp__
...
struct Int8_
{
  ...
  Type * set__data(const int8_t & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Int8_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__int8__struct__hpp__
