...
#ifndef __std_msgs__msg__multi_array_dimension__struct__hpp__
#define __std_msgs__msg__multi_array_dimension__struct__hpp__
...
struct MultiArrayDimension_
{
  ...
  Type * set__label(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
    this->label = _arg;
    return this;
  }
  Type * set__size(const uint32_t & _arg)
  {
    this->size = _arg;
    return this;
  }
  Type * set__stride(const uint32_t & _arg)
  {
    this->stride = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::MultiArrayDimension_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__multi_array_dimension__struct__hpp__
