...
#ifndef __std_msgs__msg__int32_multi_array__struct__hpp__
#define __std_msgs__msg__int32_multi_array__struct__hpp__
...
struct Int32MultiArray_
{
  ...
  Type * set__data(const std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other> & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Int32MultiArray_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__int32_multi_array__struct__hpp__
