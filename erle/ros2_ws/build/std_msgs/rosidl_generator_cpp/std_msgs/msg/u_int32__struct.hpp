...
#ifndef __std_msgs__msg__u_int32__struct__hpp__
#define __std_msgs__msg__u_int32__struct__hpp__
...
struct UInt32_
{
  ...
  Type * set__data(const uint32_t & _arg)
  {
    this->data = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::UInt32_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__u_int32__struct__hpp__
