...
#ifndef __std_msgs__msg__header__struct__hpp__
#define __std_msgs__msg__header__struct__hpp__
...
struct Header_
{
  ...
  Type * set__frame_id(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
    this->frame_id = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<std_msgs::msg::Header_<ContainerAllocator>>>
...
#endif  // __std_msgs__msg__header__struct__hpp__
