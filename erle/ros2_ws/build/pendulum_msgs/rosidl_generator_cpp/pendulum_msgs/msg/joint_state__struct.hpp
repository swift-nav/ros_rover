...
#ifndef __pendulum_msgs__msg__joint_state__struct__hpp__
#define __pendulum_msgs__msg__joint_state__struct__hpp__
...
struct JointState_
{
  ...
  Type * set__velocity(const double & _arg)
  {
    this->velocity = _arg;
    return this;
  }
  Type * set__effort(const double & _arg)
  {
    this->effort = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<pendulum_msgs::msg::JointState_<ContainerAllocator>>>
...
#endif  // __pendulum_msgs__msg__joint_state__struct__hpp__
