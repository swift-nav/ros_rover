...
#ifndef __pendulum_msgs__msg__rttest_results__struct__hpp__
#define __pendulum_msgs__msg__rttest_results__struct__hpp__
...
struct RttestResults_
{
  ...
  RttestResults_(const ContainerAllocator & _alloc)
  {
    (void)_alloc;
  }
  ...
  Type * set__stamp(const builtin_interfaces::msg::Time_<ContainerAllocator> & _arg)
  {
    this->stamp = _arg;
    return this;
  }
  Type * set__command(const pendulum_msgs::msg::JointCommand_<ContainerAllocator> & _arg)
  {
    this->command = _arg;
    return this;
  }
  Type * set__state(const pendulum_msgs::msg::JointState_<ContainerAllocator> & _arg)
  {
    this->state = _arg;
    return this;
  }
  Type * set__cur_latency(const uint64_t & _arg)
  {
    this->cur_latency = _arg;
    return this;
  }
  Type * set__mean_latency(const double & _arg)
  {
    this->mean_latency = _arg;
    return this;
  }
  Type * set__min_latency(const uint64_t & _arg)
  {
    this->min_latency = _arg;
    return this;
  }
  Type * set__max_latency(const uint64_t & _arg)
  {
    this->max_latency = _arg;
    return this;
  }
  Type * set__minor_pagefaults(const uint64_t & _arg)
  {
    this->minor_pagefaults = _arg;
    return this;
  }
  Type * set__major_pagefaults(const uint64_t & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<pendulum_msgs::msg::RttestResults_<ContainerAllocator>>>
...
#endif  // __pendulum_msgs__msg__rttest_results__struct__hpp__
