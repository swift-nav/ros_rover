...
# to pendulum_msgs_DEFINITIONS , pendulum_msgs_INCLUDE_DIRS and
# pendulum_msgs_LIBRARIES.
...
if(NOT "${_exported_dependencies} " STREQUAL " ")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(${_dep}_DEFINITIONS)
      list(APPEND pendulum_msgs_DEFINITIONS "${${_dep}_DEFINITIONS}")
    endif()
    if(${_dep}_INCLUDE_DIRS)
      list(APPEND pendulum_msgs_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
    endif()
    if(${_dep}_LIBRARIES)
      list(APPEND pendulum_msgs_LIBRARIES "${${_dep}_LIBRARIES}")
    endif()
