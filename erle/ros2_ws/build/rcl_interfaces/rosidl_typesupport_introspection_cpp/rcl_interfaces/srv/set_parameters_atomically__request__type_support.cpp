...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetParametersAtomically_Request_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle_introspection<rcl_interfaces::msg::Parameter>(),  // members of sub message
    true,  // is array
    0,  // array size
...
get_message_type_support_handle_introspection<rcl_interfaces::srv::SetParametersAtomically_Request>()
{
