...
#ifndef __rcl_interfaces__msg__parameter_value__struct__hpp__
#define __rcl_interfaces__msg__parameter_value__struct__hpp__
...
struct ParameterValue_
{
  ...
  ParameterValue_(const ContainerAllocator & _alloc)
  : bytes_value(_alloc)
  {
  }
  ...
  Type * set__type(const uint8_t & _arg)
  {
    this->type = _arg;
    return this;
  }
  ...
  Type * set__integer_value(const int64_t & _arg)
  {
    this->integer_value = _arg;
    return this;
  }
  Type * set__double_value(const double & _arg)
  {
  ...
  Type * set__bytes_value(const std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other> & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterValue_<ContainerAllocator>>>
...
#endif  // __rcl_interfaces__msg__parameter_value__struct__hpp__
