...
#ifndef __rcl_interfaces__msg__parameter_descriptor__struct__hpp__
#define __rcl_interfaces__msg__parameter_descriptor__struct__hpp__
...
struct ParameterDescriptor_
{
  ...
  ParameterDescriptor_(const ContainerAllocator & _alloc)
  {
    (void)_alloc;
  }
  ...
  Type * set__name(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
    this->name = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterDescriptor_<ContainerAllocator>>>
...
#endif  // __rcl_interfaces__msg__parameter_descriptor__struct__hpp__
