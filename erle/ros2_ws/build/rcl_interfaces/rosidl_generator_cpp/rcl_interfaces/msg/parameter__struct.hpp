...
#ifndef __rcl_interfaces__msg__parameter__struct__hpp__
#define __rcl_interfaces__msg__parameter__struct__hpp__
...
struct Parameter_
{
  ...
  Type * set__value(const rcl_interfaces::msg::ParameterValue_<ContainerAllocator> & _arg)
  {
    this->value = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<rcl_interfaces::msg::Parameter_<ContainerAllocator>>>
...
#endif  // __rcl_interfaces__msg__parameter__struct__hpp__
