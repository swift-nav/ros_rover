...
#ifndef __rcl_interfaces__msg__parameter_event__struct__hpp__
#define __rcl_interfaces__msg__parameter_event__struct__hpp__
...
struct ParameterEvent_
{
  ...
  ParameterEvent_(const ContainerAllocator & _alloc)
  ...
  Type * set__new_parameters(const std::vector<rcl_interfaces::msg::Parameter_<ContainerAllocator>, typename ContainerAllocator::template rebind<rcl_interfaces::msg::Parameter_<ContainerAllocator>>::other> & _arg)
  {
    this->new_parameters = _arg;
    return this;
  }
  Type * set__changed_parameters(const std::vector<rcl_interfaces::msg::Parameter_<ContainerAllocator>, typename ContainerAllocator::template rebind<rcl_interfaces::msg::Parameter_<ContainerAllocator>>::other> & _arg)
  {
    this->changed_parameters = _arg;
    return this;
  }
  Type * set__deleted_parameters(const std::vector<rcl_interfaces::msg::Parameter_<ContainerAllocator>, typename ContainerAllocator::template rebind<rcl_interfaces::msg::Parameter_<ContainerAllocator>>::other> & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<rcl_interfaces::msg::ParameterEvent_<ContainerAllocator>>>
...
#endif  // __rcl_interfaces__msg__parameter_event__struct__hpp__
