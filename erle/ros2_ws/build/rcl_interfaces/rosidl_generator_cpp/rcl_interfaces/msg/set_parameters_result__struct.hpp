...
#ifndef __rcl_interfaces__msg__set_parameters_result__struct__hpp__
#define __rcl_interfaces__msg__set_parameters_result__struct__hpp__
...
struct SetParametersResult_
{
  ...
  SetParametersResult_(const ContainerAllocator & _alloc)
  {
    (void)_alloc;
  }
  ...
  Type * set__successful(const bool & _arg)
  {
    this->successful = _arg;
    return this;
  }
  Type * set__reason(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
    this->reason = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<rcl_interfaces::msg::SetParametersResult_<ContainerAllocator>>>
...
#endif  // __rcl_interfaces__msg__set_parameters_result__struct__hpp__
