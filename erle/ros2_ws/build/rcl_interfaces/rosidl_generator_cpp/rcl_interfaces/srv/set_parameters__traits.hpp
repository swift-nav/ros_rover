...
#ifndef __rcl_interfaces__srv__set_parameters__traits__hpp__
#define __rcl_interfaces__srv__set_parameters__traits__hpp__
template <>
struct has_fixed_size<rcl_interfaces::srv::SetParameters>
{
  static const bool value = has_fixed_size<rcl_interfaces::srv::SetParameters_Request>::value
    && has_fixed_size<rcl_interfaces::srv::SetParameters_Response>::value;
};

#endif  // __rcl_interfaces__srv__set_parameters__traits__hpp__
