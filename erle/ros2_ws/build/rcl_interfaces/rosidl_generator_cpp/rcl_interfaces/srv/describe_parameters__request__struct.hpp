...
#ifndef __rcl_interfaces__srv__describe_parameters__request__struct__hpp__
#define __rcl_interfaces__srv__describe_parameters__request__struct__hpp__
...
struct DescribeParameters_Request_
{
  ...
  DescribeParameters_Request_(const ContainerAllocator & _alloc)
  : names(_alloc)
  {
  }
  ...
  template<typename Deleter = std::default_delete<rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator>>>
...
#endif  // __rcl_interfaces__srv__describe_parameters__request__struct__hpp__
