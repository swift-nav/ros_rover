...
#ifndef __rcl_interfaces__srv__set_parameters__response__struct__hpp__
#define __rcl_interfaces__srv__set_parameters__response__struct__hpp__
...
struct SetParameters_Response_
{
  ...
  SetParameters_Response_(const ContainerAllocator & _alloc)
  : results(_alloc)
  {
  }
  ...
  Type * set__results(const std::vector<rcl_interfaces::msg::SetParametersResult_<ContainerAllocator>, typename ContainerAllocator::template rebind<rcl_interfaces::msg::SetParametersResult_<ContainerAllocator>>::other> & _arg)
  {
    this->results = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<rcl_interfaces::srv::SetParameters_Response_<ContainerAllocator>>>
...
#endif  // __rcl_interfaces__srv__set_parameters__response__struct__hpp__
