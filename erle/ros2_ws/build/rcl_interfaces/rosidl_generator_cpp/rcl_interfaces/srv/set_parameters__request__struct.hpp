...
#ifndef __rcl_interfaces__srv__set_parameters__request__struct__hpp__
#define __rcl_interfaces__srv__set_parameters__request__struct__hpp__
...
struct SetParameters_Request_
{
  ...
  SetParameters_Request_(const ContainerAllocator & _alloc)
  : parameters(_alloc)
  {
  }
  ...
  template<typename Deleter = std::default_delete<rcl_interfaces::srv::SetParameters_Request_<ContainerAllocator>>>
...
#endif  // __rcl_interfaces__srv__set_parameters__request__struct__hpp__
