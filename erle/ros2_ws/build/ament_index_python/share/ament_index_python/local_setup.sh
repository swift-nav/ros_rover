...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ament_index_python/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ament_index_python/environment/pythonpath.sh"
