...
set(_exported_library_targets "builtin_interfaces__rosidl_typesupport_introspection_cpp;builtin_interfaces__rosidl_typesupport_opensplice_cpp")
...
if(NOT "${_exported_library_targets} " STREQUAL " ")
  ...
  while(_i LESS _length)
    ...
    if(NOT _lib)
      ...
      message(FATAL_ERROR "Package 'builtin_interfaces' exports the library '${_library_target}' which couldn't be found")
    elseif(NOT IS_ABSOLUTE "${_lib}")
      # the found library must be an absolute path
      message(FATAL_ERROR "Package 'builtin_interfaces' found the library '${_library_target}' at '${_lib}' which is not an absolute path")
...
# append absolute libraries to builtin_interfaces_LIBRARIES
if(NOT "${_exported_absolute_libraries} " STREQUAL " ")
  ...
  while(_i LESS _length)
    ...
    if(NOT EXISTS "${_absolute_library}")
      # the found library must exist
      message(WARNING "Package 'builtin_interfaces' exports the library '${_absolute_library}' which doesn't exist")
    else()
      list(APPEND builtin_interfaces_LIBRARIES ${_cfg} "${_absolute_library}")
    endif()
  endwhile()
endif()
...
if(NOT "${_exported_library_names} " STREQUAL " ")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'builtin_interfaces' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND builtin_interfaces_LIBRARIES ${_cfg} "${_lib}")
...
# deduplicate builtin_interfaces_LIBRARIES
