...
if [ -n "$AMENT_TRACE_SETUP_FILES" ]; then
  echo ". \"/home/erle/ros2_ws/install/share/rcl/local_setup.sh\""
fi
if [ -f "/home/erle/ros2_ws/install/share/rcl/local_setup.sh" ]; then
  . "/home/erle/ros2_ws/install/share/rcl/local_setup.sh"
fi
