...
#include "sensor_msgs/msg/dds_opensplice/magnetic_field__type_support.hpp"
#include "sensor_msgs/msg/dds_opensplice/ccpp_MagneticField_.h"
...
using __dds_msg_type = sensor_msgs::msg::dds_::MagneticField_;
using __ros_msg_type = sensor_msgs::msg::MagneticField;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_sensor_msgs
const char *
register_type__MagneticField(
  ...
  const char * type_name)
{
  ...
  sensor_msgs::msg::dds_::MagneticField_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::MagneticField_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::MagneticField_TypeSupport.register_type: unknown return code";
  }
}
...
convert_ros_message_to_dds(const __ros_msg_type & ros_message, __dds_msg_type & dds_message)
{
  ...
  geometry_msgs::msg::typesupport_opensplice_cpp::convert_ros_message_to_dds(
    ros_message.magnetic_field, dds_message.magnetic_field_);

  // field.name magnetic_field_covariance
  {
    size_t size = 9;
    for (DDS::ULong i = 0; i < size; i++) {
      dds_message.magnetic_field_covariance_[i] = ros_message.magnetic_field_covariance[i];
    }
  }
  ...
  const void * untyped_ros_message)
{
  ...
  sensor_msgs::msg::dds_::MagneticField_DataWriter * data_writer =
    sensor_msgs::msg::dds_::MagneticField_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::MagneticField_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "sensor_msgs::msg::dds_::MagneticField_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::MagneticField_DataWriter.write: "
             "this sensor_msgs::msg::dds_::MagneticField_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "sensor_msgs::msg::dds_::MagneticField_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "sensor_msgs::msg::dds_::MagneticField_DataWriter.write: "
             "this sensor_msgs::msg::dds_::MagneticField_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::MagneticField_DataWriter.write: "
             "the handle has not been registered with this sensor_msgs::msg::dds_::MagneticField_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::MagneticField_DataWriter.write: unknown return code";
  }
}
...
convert_dds_message_to_ros(const __dds_msg_type & dds_message, __ros_msg_type & ros_message)
{
  ...
  geometry_msgs::msg::typesupport_opensplice_cpp::convert_dds_message_to_ros(
    dds_message.magnetic_field_, ros_message.magnetic_field);

  // field.name magnetic_field_covariance
  {
    size_t size = 9;
    for (DDS::ULong i = 0; i < size; i++) {
      ros_message.magnetic_field_covariance[i] =
        dds_message.magnetic_field_covariance_[i];
    }
  }
  ...
  void * sending_publication_handle)
{
  ...
  sensor_msgs::msg::dds_::MagneticField_DataReader * data_reader =
    sensor_msgs::msg::dds_::MagneticField_DataReader::_narrow(topic_reader);

  sensor_msgs::msg::dds_::MagneticField_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "sensor_msgs::msg::dds_::MagneticField_DataReader.take: "
             "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "sensor_msgs::msg::dds_::MagneticField_DataReader.take: "
             "this sensor_msgs::msg::dds_::MagneticField_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "sensor_msgs::msg::dds_::MagneticField_DataReader.take: "
             "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "sensor_msgs::msg::dds_::MagneticField_DataReader.take: "
             "this sensor_msgs::msg::dds_::MagneticField_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "sensor_msgs::msg::dds_::MagneticField_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "sensor_msgs::msg::dds_::MagneticField_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::MagneticField_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::MagneticField_DataReader.return_loan: "
             "this sensor_msgs::msg::dds_::MagneticField_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::MagneticField_DataReader.return_loan: "
             ...
             "sensor_msgs::msg::dds_::MagneticField_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::MagneticField_DataReader.return_loan failed with "
             "unknown return code";
  }
