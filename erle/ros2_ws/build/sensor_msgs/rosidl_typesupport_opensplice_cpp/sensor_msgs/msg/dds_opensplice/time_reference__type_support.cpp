...
#include "sensor_msgs/msg/dds_opensplice/time_reference__type_support.hpp"
...
using __dds_msg_type = sensor_msgs::msg::dds_::TimeReference_;
using __ros_msg_type = sensor_msgs::msg::TimeReference;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_sensor_msgs
const char *
register_type__TimeReference(
  ...
  const char * type_name)
{
  ...
  sensor_msgs::msg::dds_::TimeReference_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::TimeReference_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::TimeReference_TypeSupport.register_type: unknown return code";
  }
}
...
convert_ros_message_to_dds(const __ros_msg_type & ros_message, __dds_msg_type & dds_message)
{
  ...
  builtin_interfaces::msg::typesupport_opensplice_cpp::convert_ros_message_to_dds(
    ros_message.time_ref, dds_message.time_ref_);

  // field.name source
  dds_message.source_ = ros_message.source.c_str();

}

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_sensor_msgs
const char *
publish__TimeReference(
  ...
  const void * untyped_ros_message)
{
  ...
  sensor_msgs::msg::dds_::TimeReference_DataWriter * data_writer =
    sensor_msgs::msg::dds_::TimeReference_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::TimeReference_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "sensor_msgs::msg::dds_::TimeReference_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::TimeReference_DataWriter.write: "
             "this sensor_msgs::msg::dds_::TimeReference_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "sensor_msgs::msg::dds_::TimeReference_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "sensor_msgs::msg::dds_::TimeReference_DataWriter.write: "
             "this sensor_msgs::msg::dds_::TimeReference_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::TimeReference_DataWriter.write: "
             "the handle has not been registered with this sensor_msgs::msg::dds_::TimeReference_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::TimeReference_DataWriter.write: unknown return code";
  }
}
...
convert_dds_message_to_ros(const __dds_msg_type & dds_message, __ros_msg_type & ros_message)
{
  ...
  builtin_interfaces::msg::typesupport_opensplice_cpp::convert_dds_message_to_ros(
    dds_message.time_ref_, ros_message.time_ref);
  ...
  void * sending_publication_handle)
{
  ...
  sensor_msgs::msg::dds_::TimeReference_DataReader * data_reader =
    sensor_msgs::msg::dds_::TimeReference_DataReader::_narrow(topic_reader);

  sensor_msgs::msg::dds_::TimeReference_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "sensor_msgs::msg::dds_::TimeReference_DataReader.take: "
             "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "sensor_msgs::msg::dds_::TimeReference_DataReader.take: "
             "this sensor_msgs::msg::dds_::TimeReference_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "sensor_msgs::msg::dds_::TimeReference_DataReader.take: "
             "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "sensor_msgs::msg::dds_::TimeReference_DataReader.take: "
             "this sensor_msgs::msg::dds_::TimeReference_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "sensor_msgs::msg::dds_::TimeReference_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "sensor_msgs::msg::dds_::TimeReference_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::TimeReference_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::TimeReference_DataReader.return_loan: "
             "this sensor_msgs::msg::dds_::TimeReference_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::TimeReference_DataReader.return_loan: "
             ...
             "sensor_msgs::msg::dds_::TimeReference_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::TimeReference_DataReader.return_loan failed with "
             "unknown return code";
  }
