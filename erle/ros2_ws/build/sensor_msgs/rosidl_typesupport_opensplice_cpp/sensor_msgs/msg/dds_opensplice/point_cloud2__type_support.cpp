...
#include "sensor_msgs/msg/dds_opensplice/point_cloud2__type_support.hpp"
#include "sensor_msgs/msg/dds_opensplice/ccpp_PointCloud2_.h"
...
void convert_dds_message_to_ros(
  const sensor_msgs::msg::dds_::PointField_ &,
...
using __dds_msg_type = sensor_msgs::msg::dds_::PointCloud2_;
using __ros_msg_type = sensor_msgs::msg::PointCloud2;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_sensor_msgs
const char *
register_type__PointCloud2(
  ...
  const char * type_name)
{
  ...
  sensor_msgs::msg::dds_::PointCloud2_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::PointCloud2_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::PointCloud2_TypeSupport.register_type: unknown return code";
  }
}
...
convert_ros_message_to_dds(const __ros_msg_type & ros_message, __dds_msg_type & dds_message)
{
  ...
  dds_message.point_step_ = ros_message.point_step;

  // field.name row_step
  dds_message.row_step_ = ros_message.row_step;
  ...
  // field.name is_dense
  dds_message.is_dense_ = ros_message.is_dense;

}

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_sensor_msgs
const char *
publish__PointCloud2(
  ...
  const void * untyped_ros_message)
{
  ...
  sensor_msgs::msg::dds_::PointCloud2_DataWriter * data_writer =
    sensor_msgs::msg::dds_::PointCloud2_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::PointCloud2_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "sensor_msgs::msg::dds_::PointCloud2_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::PointCloud2_DataWriter.write: "
             "this sensor_msgs::msg::dds_::PointCloud2_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "sensor_msgs::msg::dds_::PointCloud2_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "sensor_msgs::msg::dds_::PointCloud2_DataWriter.write: "
             "this sensor_msgs::msg::dds_::PointCloud2_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::PointCloud2_DataWriter.write: "
             "the handle has not been registered with this sensor_msgs::msg::dds_::PointCloud2_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::PointCloud2_DataWriter.write: unknown return code";
  }
}
...
convert_dds_message_to_ros(const __dds_msg_type & dds_message, __ros_msg_type & ros_message)
{
  ...
  // field.name fields
  {
    size_t size = dds_message.fields_.length();
    ros_message.fields.resize(size);
    for (DDS::ULong i = 0; i < size; i++) {
      sensor_msgs::msg::typesupport_opensplice_cpp::convert_dds_message_to_ros(
        dds_message.fields_[i], ros_message.fields[i]);
    }
  }

  // field.name is_bigendian
  ros_message.is_bigendian =
    dds_message.is_bigendian_ == TRUE;

  // field.name point_step
  ros_message.point_step =
    dds_message.point_step_;

  // field.name row_step
  ros_message.row_step =
    dds_message.row_step_;
  ...
  // field.name is_dense
  ros_message.is_dense =
    dds_message.is_dense_ == TRUE;
  ...
  void * sending_publication_handle)
{
  ...
  sensor_msgs::msg::dds_::PointCloud2_DataReader * data_reader =
    sensor_msgs::msg::dds_::PointCloud2_DataReader::_narrow(topic_reader);

  sensor_msgs::msg::dds_::PointCloud2_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "sensor_msgs::msg::dds_::PointCloud2_DataReader.take: "
             "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "sensor_msgs::msg::dds_::PointCloud2_DataReader.take: "
             "this sensor_msgs::msg::dds_::PointCloud2_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "sensor_msgs::msg::dds_::PointCloud2_DataReader.take: "
             "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "sensor_msgs::msg::dds_::PointCloud2_DataReader.take: "
             "this sensor_msgs::msg::dds_::PointCloud2_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "sensor_msgs::msg::dds_::PointCloud2_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "sensor_msgs::msg::dds_::PointCloud2_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::PointCloud2_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::PointCloud2_DataReader.return_loan: "
             "this sensor_msgs::msg::dds_::PointCloud2_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::PointCloud2_DataReader.return_loan: "
             ...
             "sensor_msgs::msg::dds_::PointCloud2_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::PointCloud2_DataReader.return_loan failed with "
             "unknown return code";
  }
