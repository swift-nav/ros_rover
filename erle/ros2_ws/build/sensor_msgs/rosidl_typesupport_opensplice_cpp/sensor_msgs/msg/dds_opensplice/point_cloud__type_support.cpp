...
#include "sensor_msgs/msg/dds_opensplice/point_cloud__type_support.hpp"
...
void convert_dds_message_to_ros(
  const sensor_msgs::msg::dds_::ChannelFloat32_ &,
...
using __dds_msg_type = sensor_msgs::msg::dds_::PointCloud_;
using __ros_msg_type = sensor_msgs::msg::PointCloud;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_sensor_msgs
const char *
register_type__PointCloud(
  ...
  const char * type_name)
{
  ...
  sensor_msgs::msg::dds_::PointCloud_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::PointCloud_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::PointCloud_TypeSupport.register_type: unknown return code";
  }
}
...
convert_ros_message_to_dds(const __ros_msg_type & ros_message, __dds_msg_type & dds_message)
{
  ...
  // field.name channels
  {
    ...
    DDS::Long length = static_cast<DDS::Long>(size);
    dds_message.channels_.length(length);
    for (DDS::ULong i = 0; i < size; i++) {
      sensor_msgs::msg::typesupport_opensplice_cpp::convert_ros_message_to_dds(
        ros_message.channels[i], dds_message.channels_[i]);
    }
  }
  ...
  const void * untyped_ros_message)
{
  ...
  sensor_msgs::msg::dds_::PointCloud_DataWriter * data_writer =
    sensor_msgs::msg::dds_::PointCloud_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::PointCloud_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "sensor_msgs::msg::dds_::PointCloud_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::PointCloud_DataWriter.write: "
             "this sensor_msgs::msg::dds_::PointCloud_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "sensor_msgs::msg::dds_::PointCloud_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "sensor_msgs::msg::dds_::PointCloud_DataWriter.write: "
             "this sensor_msgs::msg::dds_::PointCloud_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::PointCloud_DataWriter.write: "
             "the handle has not been registered with this sensor_msgs::msg::dds_::PointCloud_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::PointCloud_DataWriter.write: unknown return code";
  }
}
  ...
  void * sending_publication_handle)
{
  ...
  sensor_msgs::msg::dds_::PointCloud_DataReader * data_reader =
    sensor_msgs::msg::dds_::PointCloud_DataReader::_narrow(topic_reader);

  sensor_msgs::msg::dds_::PointCloud_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "sensor_msgs::msg::dds_::PointCloud_DataReader.take: "
             "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "sensor_msgs::msg::dds_::PointCloud_DataReader.take: "
             "this sensor_msgs::msg::dds_::PointCloud_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "sensor_msgs::msg::dds_::PointCloud_DataReader.take: "
             "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "sensor_msgs::msg::dds_::PointCloud_DataReader.take: "
             "this sensor_msgs::msg::dds_::PointCloud_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "sensor_msgs::msg::dds_::PointCloud_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "sensor_msgs::msg::dds_::PointCloud_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::PointCloud_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::PointCloud_DataReader.return_loan: "
             "this sensor_msgs::msg::dds_::PointCloud_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::PointCloud_DataReader.return_loan: "
             ...
             "sensor_msgs::msg::dds_::PointCloud_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::PointCloud_DataReader.return_loan failed with "
             "unknown return code";
  }
