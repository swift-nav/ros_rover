...
#include "sensor_msgs/msg/dds_opensplice/temperature__type_support.hpp"
#include "sensor_msgs/msg/dds_opensplice/ccpp_Temperature_.h"
...
using __dds_msg_type = sensor_msgs::msg::dds_::Temperature_;
using __ros_msg_type = sensor_msgs::msg::Temperature;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_sensor_msgs
const char *
register_type__Temperature(
  ...
  const char * type_name)
{
  ...
  sensor_msgs::msg::dds_::Temperature_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::Temperature_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::Temperature_TypeSupport.register_type: unknown return code";
  }
}
  ...
  const void * untyped_ros_message)
{
  ...
  sensor_msgs::msg::dds_::Temperature_DataWriter * data_writer =
    sensor_msgs::msg::dds_::Temperature_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::Temperature_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "sensor_msgs::msg::dds_::Temperature_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::Temperature_DataWriter.write: "
             "this sensor_msgs::msg::dds_::Temperature_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "sensor_msgs::msg::dds_::Temperature_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "sensor_msgs::msg::dds_::Temperature_DataWriter.write: "
             "this sensor_msgs::msg::dds_::Temperature_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::Temperature_DataWriter.write: "
             "the handle has not been registered with this sensor_msgs::msg::dds_::Temperature_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::Temperature_DataWriter.write: unknown return code";
  }
}
  ...
  void * sending_publication_handle)
{
  ...
  sensor_msgs::msg::dds_::Temperature_DataReader * data_reader =
    sensor_msgs::msg::dds_::Temperature_DataReader::_narrow(topic_reader);

  sensor_msgs::msg::dds_::Temperature_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "sensor_msgs::msg::dds_::Temperature_DataReader.take: "
             "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "sensor_msgs::msg::dds_::Temperature_DataReader.take: "
             "this sensor_msgs::msg::dds_::Temperature_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "sensor_msgs::msg::dds_::Temperature_DataReader.take: "
             "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "sensor_msgs::msg::dds_::Temperature_DataReader.take: "
             "this sensor_msgs::msg::dds_::Temperature_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "sensor_msgs::msg::dds_::Temperature_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "sensor_msgs::msg::dds_::Temperature_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "sensor_msgs::msg::dds_::Temperature_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "sensor_msgs::msg::dds_::Temperature_DataReader.return_loan: "
             "this sensor_msgs::msg::dds_::Temperature_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "sensor_msgs::msg::dds_::Temperature_DataReader.return_loan: "
             ...
             "sensor_msgs::msg::dds_::Temperature_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "sensor_msgs::msg::dds_::Temperature_DataReader.return_loan failed with "
             "unknown return code";
  }
