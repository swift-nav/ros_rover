...
extern const char * __sensor_msgs_srv_dds__Sample_SetCameraInfo_Response___keys (void);
extern const char * __sensor_msgs_srv_dds__Sample_SetCameraInfo_Response___name (void);
struct _sensor_msgs_srv_dds__Sample_SetCameraInfo_Response_ ;
extern  c_bool __sensor_msgs_srv_dds__Sample_SetCameraInfo_Response___copyIn(c_base base, struct sensor_msgs::srv::dds_::Sample_SetCameraInfo_Response_ *from, struct _sensor_msgs_srv_dds__Sample_SetCameraInfo_Response_ *to);
extern  void __sensor_msgs_srv_dds__Sample_SetCameraInfo_Response___copyOut(void *_from, void *_to);
struct _sensor_msgs_srv_dds__Sample_SetCameraInfo_Response_ {
