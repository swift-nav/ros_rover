...
#ifndef __sensor_msgs__srv__set_camera_info__response__struct__hpp__
#define __sensor_msgs__srv__set_camera_info__response__struct__hpp__
...
struct SetCameraInfo_Response_
{
  ...
  SetCameraInfo_Response_(const ContainerAllocator & _alloc)
  {
    (void)_alloc;
  }
  ...
  Type * set__success(const bool & _arg)
  {
    this->success = _arg;
    return this;
  }
  Type * set__status_message(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::srv::SetCameraInfo_Response_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__srv__set_camera_info__response__struct__hpp__
