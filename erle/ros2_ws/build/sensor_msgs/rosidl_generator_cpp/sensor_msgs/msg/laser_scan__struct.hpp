...
#ifndef __sensor_msgs__msg__laser_scan__struct__hpp__
#define __sensor_msgs__msg__laser_scan__struct__hpp__
...
struct LaserScan_
{
  ...
  Type * set__ranges(const std::vector<float, typename ContainerAllocator::template rebind<float>::other> & _arg)
  {
    this->ranges = _arg;
    return this;
  }
  Type * set__intensities(const std::vector<float, typename ContainerAllocator::template rebind<float>::other> & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::LaserScan_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__laser_scan__struct__hpp__
