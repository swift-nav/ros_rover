...
#ifndef __sensor_msgs__msg__fluid_pressure__struct__hpp__
#define __sensor_msgs__msg__fluid_pressure__struct__hpp__
...
struct FluidPressure_
{
  ...
  Type * set__fluid_pressure(const double & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::FluidPressure_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__fluid_pressure__struct__hpp__
