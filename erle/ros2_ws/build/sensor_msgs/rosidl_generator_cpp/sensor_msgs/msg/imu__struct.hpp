...
#ifndef __sensor_msgs__msg__imu__struct__hpp__
#define __sensor_msgs__msg__imu__struct__hpp__
...
struct Imu_
{
  ...
  Type * set__orientation(const geometry_msgs::msg::Quaternion_<ContainerAllocator> & _arg)
  {
    this->orientation = _arg;
    return this;
  }
  Type * set__orientation_covariance(const std::array<double, 9> & _arg)
  {
    this->orientation_covariance = _arg;
    return this;
  }
  Type * set__angular_velocity(const geometry_msgs::msg::Vector3_<ContainerAllocator> & _arg)
  {
    this->angular_velocity = _arg;
    return this;
  }
  Type * set__angular_velocity_covariance(const std::array<double, 9> & _arg)
  {
    this->angular_velocity_covariance = _arg;
    return this;
  }
  Type * set__linear_acceleration(const geometry_msgs::msg::Vector3_<ContainerAllocator> & _arg)
  {
    this->linear_acceleration = _arg;
    return this;
  }
  Type * set__linear_acceleration_covariance(const std::array<double, 9> & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::Imu_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__imu__struct__hpp__
