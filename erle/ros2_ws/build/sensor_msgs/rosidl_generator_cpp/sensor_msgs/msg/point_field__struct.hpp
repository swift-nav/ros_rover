...
#ifndef __sensor_msgs__msg__point_field__struct__hpp__
#define __sensor_msgs__msg__point_field__struct__hpp__
...
struct PointField_
{
  ...
  Type * set__offset(const uint32_t & _arg)
  {
    this->offset = _arg;
    return this;
  }
  Type * set__datatype(const uint8_t & _arg)
  {
    this->datatype = _arg;
    return this;
  }
  Type * set__count(const uint32_t & _arg)
  {
    this->count = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::PointField_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__point_field__struct__hpp__
