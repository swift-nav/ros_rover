...
#ifndef __sensor_msgs__msg__image__struct__hpp__
#define __sensor_msgs__msg__image__struct__hpp__
...
struct Image_
{
  ...
  Type * set__encoding(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
    this->encoding = _arg;
    return this;
  }
  Type * set__is_bigendian(const uint8_t & _arg)
  {
    this->is_bigendian = _arg;
    return this;
  }
  Type * set__step(const uint32_t & _arg)
  {
    this->step = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::Image_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__image__struct__hpp__
