...
#ifndef __sensor_msgs__msg__point_cloud2__struct__hpp__
#define __sensor_msgs__msg__point_cloud2__struct__hpp__
...
struct PointCloud2_
{
  ...
  Type * set__fields(const std::vector<sensor_msgs::msg::PointField_<ContainerAllocator>, typename ContainerAllocator::template rebind<sensor_msgs::msg::PointField_<ContainerAllocator>>::other> & _arg)
  {
    this->fields = _arg;
    return this;
  }
  ...
  Type * set__point_step(const uint32_t & _arg)
  {
    this->point_step = _arg;
    return this;
  }
  Type * set__row_step(const uint32_t & _arg)
  {
    this->row_step = _arg;
    return this;
  }
  ...
  Type * set__is_dense(const bool & _arg)
  {
    this->is_dense = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::PointCloud2_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__point_cloud2__struct__hpp__
