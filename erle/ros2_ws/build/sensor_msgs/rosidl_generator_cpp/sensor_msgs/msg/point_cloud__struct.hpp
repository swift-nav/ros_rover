...
#ifndef __sensor_msgs__msg__point_cloud__struct__hpp__
#define __sensor_msgs__msg__point_cloud__struct__hpp__
...
struct PointCloud_
{
  ...
  Type * set__channels(const std::vector<sensor_msgs::msg::ChannelFloat32_<ContainerAllocator>, typename ContainerAllocator::template rebind<sensor_msgs::msg::ChannelFloat32_<ContainerAllocator>>::other> & _arg)
  {
    this->channels = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::PointCloud_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__point_cloud__struct__hpp__
