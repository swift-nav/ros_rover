...
#ifndef __sensor_msgs__msg__nav_sat_status__struct__hpp__
#define __sensor_msgs__msg__nav_sat_status__struct__hpp__
...
struct NavSatStatus_
{
  ...
  Type * set__status(const int8_t & _arg)
  {
    this->status = _arg;
    return this;
  }
  Type * set__service(const uint16_t & _arg)
  {
    this->service = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::NavSatStatus_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__nav_sat_status__struct__hpp__
