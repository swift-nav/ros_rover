...
#ifndef __sensor_msgs__msg__multi_dof_joint_state__struct__hpp__
#define __sensor_msgs__msg__multi_dof_joint_state__struct__hpp__
...
struct MultiDOFJointState_
{
  ...
  Type * set__joint_names(const std::vector<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>, typename ContainerAllocator::template rebind<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>>::other> & _arg)
  {
    this->joint_names = _arg;
    return this;
  }
  Type * set__transforms(const std::vector<geometry_msgs::msg::Transform_<ContainerAllocator>, typename ContainerAllocator::template rebind<geometry_msgs::msg::Transform_<ContainerAllocator>>::other> & _arg)
  {
    this->transforms = _arg;
    return this;
  }
  Type * set__twist(const std::vector<geometry_msgs::msg::Twist_<ContainerAllocator>, typename ContainerAllocator::template rebind<geometry_msgs::msg::Twist_<ContainerAllocator>>::other> & _arg)
  {
    this->twist = _arg;
    return this;
  }
  Type * set__wrench(const std::vector<geometry_msgs::msg::Wrench_<ContainerAllocator>, typename ContainerAllocator::template rebind<geometry_msgs::msg::Wrench_<ContainerAllocator>>::other> & _arg)
  {
    this->wrench = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::MultiDOFJointState_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__multi_dof_joint_state__struct__hpp__
