...
#ifndef __sensor_msgs__msg__range__struct__hpp__
#define __sensor_msgs__msg__range__struct__hpp__
...
struct Range_
{
  ...
  Type * set__radiation_type(const uint8_t & _arg)
  {
    this->radiation_type = _arg;
    return this;
  }
  Type * set__field_of_view(const float & _arg)
  {
    this->field_of_view = _arg;
    return this;
  }
  Type * set__min_range(const float & _arg)
  {
    this->min_range = _arg;
    return this;
  }
  Type * set__max_range(const float & _arg)
  {
    this->max_range = _arg;
    return this;
  }
  Type * set__range(const float & _arg)
  {
    this->range = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::Range_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__range__struct__hpp__
