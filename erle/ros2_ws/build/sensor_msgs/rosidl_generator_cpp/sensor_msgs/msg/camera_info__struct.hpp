...
#ifndef __sensor_msgs__msg__camera_info__struct__hpp__
#define __sensor_msgs__msg__camera_info__struct__hpp__
...
struct CameraInfo_
{
  ...
  Type * set__distortion_model(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
    this->distortion_model = _arg;
    return this;
  }
  Type * set__d(const std::vector<double, typename ContainerAllocator::template rebind<double>::other> & _arg)
  {
    this->d = _arg;
    return this;
  }
  Type * set__k(const std::array<double, 9> & _arg)
  {
    this->k = _arg;
    return this;
  }
  Type * set__r(const std::array<double, 9> & _arg)
  {
    this->r = _arg;
    return this;
  }
  Type * set__p(const std::array<double, 12> & _arg)
  {
    this->p = _arg;
    return this;
  }
  Type * set__binning_x(const uint32_t & _arg)
  {
    this->binning_x = _arg;
    return this;
  }
  Type * set__binning_y(const uint32_t & _arg)
  {
    this->binning_y = _arg;
    return this;
  }
  Type * set__roi(const sensor_msgs::msg::RegionOfInterest_<ContainerAllocator> & _arg)
  {
    this->roi = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::CameraInfo_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__camera_info__struct__hpp__
