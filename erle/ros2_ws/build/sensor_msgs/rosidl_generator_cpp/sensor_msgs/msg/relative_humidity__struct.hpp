...
#ifndef __sensor_msgs__msg__relative_humidity__struct__hpp__
#define __sensor_msgs__msg__relative_humidity__struct__hpp__
...
struct RelativeHumidity_
{
  ...
  Type * set__relative_humidity(const double & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::RelativeHumidity_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__relative_humidity__struct__hpp__
