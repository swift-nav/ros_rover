...
#ifndef __sensor_msgs__msg__time_reference__struct__hpp__
#define __sensor_msgs__msg__time_reference__struct__hpp__
...
struct TimeReference_
{
  ...
  Type * set__time_ref(const builtin_interfaces::msg::Time_<ContainerAllocator> & _arg)
  {
    this->time_ref = _arg;
    return this;
  }
  Type * set__source(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
    this->source = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::TimeReference_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__time_reference__struct__hpp__
