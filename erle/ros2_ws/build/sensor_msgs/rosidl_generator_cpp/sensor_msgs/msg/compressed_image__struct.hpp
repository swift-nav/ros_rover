...
#ifndef __sensor_msgs__msg__compressed_image__struct__hpp__
#define __sensor_msgs__msg__compressed_image__struct__hpp__
...
struct CompressedImage_
{
  ...
  Type * set__format(const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> & _arg)
  {
    this->format = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::CompressedImage_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__compressed_image__struct__hpp__
