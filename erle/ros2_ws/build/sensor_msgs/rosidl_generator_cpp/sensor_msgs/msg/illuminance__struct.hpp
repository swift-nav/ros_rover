...
#ifndef __sensor_msgs__msg__illuminance__struct__hpp__
#define __sensor_msgs__msg__illuminance__struct__hpp__
...
struct Illuminance_
{
  ...
  Type * set__illuminance(const double & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::Illuminance_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__illuminance__struct__hpp__
