...
#ifndef __sensor_msgs__msg__joy__struct__hpp__
#define __sensor_msgs__msg__joy__struct__hpp__
...
struct Joy_
{
  ...
  Type * set__axes(const std::vector<float, typename ContainerAllocator::template rebind<float>::other> & _arg)
  {
    this->axes = _arg;
    return this;
  }
  Type * set__buttons(const std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other> & _arg)
  {
    this->buttons = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::Joy_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__joy__struct__hpp__
