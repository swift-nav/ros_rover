...
#ifndef __sensor_msgs__msg__channel_float32__struct__hpp__
#define __sensor_msgs__msg__channel_float32__struct__hpp__
...
struct ChannelFloat32_
{
  ...
  Type * set__values(const std::vector<float, typename ContainerAllocator::template rebind<float>::other> & _arg)
  {
    this->values = _arg;
    return this;
  }
...
#endif  // __sensor_msgs__msg__channel_float32__struct__hpp__
