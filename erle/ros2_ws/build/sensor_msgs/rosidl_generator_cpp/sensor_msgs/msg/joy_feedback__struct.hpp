...
#ifndef __sensor_msgs__msg__joy_feedback__struct__hpp__
#define __sensor_msgs__msg__joy_feedback__struct__hpp__
...
struct JoyFeedback_
{
  ...
  Type * set__id(const uint8_t & _arg)
  {
    this->id = _arg;
    return this;
  }
  Type * set__intensity(const float & _arg)
  {
    this->intensity = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::JoyFeedback_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__joy_feedback__struct__hpp__
