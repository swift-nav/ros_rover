...
#ifndef __sensor_msgs__msg__temperature__struct__hpp__
#define __sensor_msgs__msg__temperature__struct__hpp__
...
struct Temperature_
{
  ...
  Type * set__temperature(const double & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::Temperature_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__temperature__struct__hpp__
