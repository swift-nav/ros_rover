...
#ifndef __sensor_msgs__msg__magnetic_field__struct__hpp__
#define __sensor_msgs__msg__magnetic_field__struct__hpp__
...
struct MagneticField_
{
  ...
  Type * set__magnetic_field(const geometry_msgs::msg::Vector3_<ContainerAllocator> & _arg)
  {
    this->magnetic_field = _arg;
    return this;
  }
  Type * set__magnetic_field_covariance(const std::array<double, 9> & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::MagneticField_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__magnetic_field__struct__hpp__
