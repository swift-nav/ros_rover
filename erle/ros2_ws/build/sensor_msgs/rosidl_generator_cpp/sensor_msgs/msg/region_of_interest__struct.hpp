...
#ifndef __sensor_msgs__msg__region_of_interest__struct__hpp__
#define __sensor_msgs__msg__region_of_interest__struct__hpp__
...
struct RegionOfInterest_
{
  ...
  Type * set__x_offset(const uint32_t & _arg)
  {
    this->x_offset = _arg;
    return this;
  }
  Type * set__y_offset(const uint32_t & _arg)
  {
    this->y_offset = _arg;
    return this;
  }
  ...
  Type * set__do_rectify(const bool & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::RegionOfInterest_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__region_of_interest__struct__hpp__
