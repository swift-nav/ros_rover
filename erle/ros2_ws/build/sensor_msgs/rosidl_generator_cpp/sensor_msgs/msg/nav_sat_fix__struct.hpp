...
#ifndef __sensor_msgs__msg__nav_sat_fix__struct__hpp__
#define __sensor_msgs__msg__nav_sat_fix__struct__hpp__
...
struct NavSatFix_
{
  ...
  Type * set__status(const sensor_msgs::msg::NavSatStatus_<ContainerAllocator> & _arg)
  {
    this->status = _arg;
    return this;
  }
  Type * set__latitude(const double & _arg)
  {
    this->latitude = _arg;
    return this;
  }
  Type * set__longitude(const double & _arg)
  {
    this->longitude = _arg;
    return this;
  }
  Type * set__altitude(const double & _arg)
  {
    this->altitude = _arg;
    return this;
  }
  Type * set__position_covariance(const std::array<double, 9> & _arg)
  {
    this->position_covariance = _arg;
    return this;
  }
  Type * set__position_covariance_type(const uint8_t & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<sensor_msgs::msg::NavSatFix_<ContainerAllocator>>>
...
#endif  // __sensor_msgs__msg__nav_sat_fix__struct__hpp__
