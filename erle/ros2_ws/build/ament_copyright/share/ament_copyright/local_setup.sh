...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ament_copyright/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ament_copyright/environment/pythonpath.sh"
