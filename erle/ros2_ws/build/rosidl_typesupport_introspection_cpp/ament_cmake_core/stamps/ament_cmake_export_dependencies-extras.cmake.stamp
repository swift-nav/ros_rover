...
set(_exported_dependencies "rosidl_cmake;rosidl_generator_c;rosidl_generator_cpp")

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS and LIBRARIES variables
# to rosidl_typesupport_introspection_cpp_DEFINITIONS , rosidl_typesupport_introspection_cpp_INCLUDE_DIRS and
...
if(NOT "${_exported_dependencies} " STREQUAL " ")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(${_dep}_DEFINITIONS)
      list(APPEND rosidl_typesupport_introspection_cpp_DEFINITIONS "${${_dep}_DEFINITIONS}")
    endif()
    if(${_dep}_INCLUDE_DIRS)
      list(APPEND rosidl_typesupport_introspection_cpp_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
    endif()
    if(${_dep}_LIBRARIES)
      list(APPEND rosidl_typesupport_introspection_cpp_LIBRARIES "${${_dep}_LIBRARIES}")
    endif()
