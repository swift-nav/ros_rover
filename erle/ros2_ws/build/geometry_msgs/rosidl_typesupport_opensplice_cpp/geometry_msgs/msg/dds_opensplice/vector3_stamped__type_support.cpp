...
#include "geometry_msgs/msg/dds_opensplice/vector3_stamped__type_support.hpp"
#include "geometry_msgs/msg/dds_opensplice/ccpp_Vector3Stamped_.h"
...
using __dds_msg_type = geometry_msgs::msg::dds_::Vector3Stamped_;
using __ros_msg_type = geometry_msgs::msg::Vector3Stamped;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_geometry_msgs
const char *
register_type__Vector3Stamped(
  ...
  const char * type_name)
{
  ...
  geometry_msgs::msg::dds_::Vector3Stamped_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "geometry_msgs::msg::dds_::Vector3Stamped_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "geometry_msgs::msg::dds_::Vector3Stamped_TypeSupport.register_type: unknown return code";
  }
}
...
convert_ros_message_to_dds(const __ros_msg_type & ros_message, __dds_msg_type & dds_message)
{
  ...
  geometry_msgs::msg::typesupport_opensplice_cpp::convert_ros_message_to_dds(
    ros_message.vector, dds_message.vector_);

}

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_geometry_msgs
const char *
publish__Vector3Stamped(
  ...
  const void * untyped_ros_message)
{
  ...
  geometry_msgs::msg::dds_::Vector3Stamped_DataWriter * data_writer =
    geometry_msgs::msg::dds_::Vector3Stamped_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataWriter.write: "
             "this geometry_msgs::msg::dds_::Vector3Stamped_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataWriter.write: "
             "this geometry_msgs::msg::dds_::Vector3Stamped_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataWriter.write: "
             "the handle has not been registered with this geometry_msgs::msg::dds_::Vector3Stamped_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataWriter.write: unknown return code";
  }
}
...
convert_dds_message_to_ros(const __dds_msg_type & dds_message, __ros_msg_type & ros_message)
{
  ...
  geometry_msgs::msg::typesupport_opensplice_cpp::convert_dds_message_to_ros(
    dds_message.vector_, ros_message.vector);

}

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_geometry_msgs
const char *
take__Vector3Stamped(
  ...
  void * sending_publication_handle)
{
  ...
  geometry_msgs::msg::dds_::Vector3Stamped_DataReader * data_reader =
    geometry_msgs::msg::dds_::Vector3Stamped_DataReader::_narrow(topic_reader);

  geometry_msgs::msg::dds_::Vector3Stamped_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.take: "
             "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.take: "
             "this geometry_msgs::msg::dds_::Vector3Stamped_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.take: "
             "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.take: "
             "this geometry_msgs::msg::dds_::Vector3Stamped_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.return_loan: "
             "this geometry_msgs::msg::dds_::Vector3Stamped_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.return_loan: "
             ...
             "geometry_msgs::msg::dds_::Vector3Stamped_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "geometry_msgs::msg::dds_::Vector3Stamped_DataReader.return_loan failed with "
             "unknown return code";
  }
