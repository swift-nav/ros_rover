...
#include "geometry_msgs/msg/dds_opensplice/vector3__type_support.hpp"
...
using __dds_msg_type = geometry_msgs::msg::dds_::Vector3_;
using __ros_msg_type = geometry_msgs::msg::Vector3;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_geometry_msgs
const char *
register_type__Vector3(
  ...
  const char * type_name)
{
  ...
  geometry_msgs::msg::dds_::Vector3_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "geometry_msgs::msg::dds_::Vector3_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "geometry_msgs::msg::dds_::Vector3_TypeSupport.register_type: unknown return code";
  }
}
  ...
  const void * untyped_ros_message)
{
  ...
  geometry_msgs::msg::dds_::Vector3_DataWriter * data_writer =
    geometry_msgs::msg::dds_::Vector3_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "geometry_msgs::msg::dds_::Vector3_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "geometry_msgs::msg::dds_::Vector3_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "geometry_msgs::msg::dds_::Vector3_DataWriter.write: "
             "this geometry_msgs::msg::dds_::Vector3_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "geometry_msgs::msg::dds_::Vector3_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "geometry_msgs::msg::dds_::Vector3_DataWriter.write: "
             "this geometry_msgs::msg::dds_::Vector3_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "geometry_msgs::msg::dds_::Vector3_DataWriter.write: "
             "the handle has not been registered with this geometry_msgs::msg::dds_::Vector3_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "geometry_msgs::msg::dds_::Vector3_DataWriter.write: unknown return code";
  }
}
  ...
  void * sending_publication_handle)
{
  ...
  geometry_msgs::msg::dds_::Vector3_DataReader * data_reader =
    geometry_msgs::msg::dds_::Vector3_DataReader::_narrow(topic_reader);

  geometry_msgs::msg::dds_::Vector3_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "geometry_msgs::msg::dds_::Vector3_DataReader.take: "
             "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "geometry_msgs::msg::dds_::Vector3_DataReader.take: "
             "this geometry_msgs::msg::dds_::Vector3_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "geometry_msgs::msg::dds_::Vector3_DataReader.take: "
             "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "geometry_msgs::msg::dds_::Vector3_DataReader.take: "
             "this geometry_msgs::msg::dds_::Vector3_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "geometry_msgs::msg::dds_::Vector3_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "geometry_msgs::msg::dds_::Vector3_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "geometry_msgs::msg::dds_::Vector3_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "geometry_msgs::msg::dds_::Vector3_DataReader.return_loan: "
             "this geometry_msgs::msg::dds_::Vector3_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "geometry_msgs::msg::dds_::Vector3_DataReader.return_loan: "
             ...
             "geometry_msgs::msg::dds_::Vector3_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "geometry_msgs::msg::dds_::Vector3_DataReader.return_loan failed with "
             "unknown return code";
  }
