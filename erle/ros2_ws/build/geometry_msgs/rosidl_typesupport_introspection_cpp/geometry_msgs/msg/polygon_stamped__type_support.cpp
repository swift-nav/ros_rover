...
#ifndef __geometry_msgs__msg__polygon_stamped__type_support__h__
#define __geometry_msgs__msg__polygon_stamped__type_support__h__
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PolygonStamped_message_member_array[2] = {
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle_introspection<geometry_msgs::msg::Polygon>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
...
get_message_type_support_handle_introspection<geometry_msgs::msg::PolygonStamped>()
{
...
#endif  // __geometry_msgs__msg__polygon_stamped__type_support__h__
