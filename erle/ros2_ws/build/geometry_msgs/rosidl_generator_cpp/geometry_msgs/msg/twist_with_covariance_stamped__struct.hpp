...
#ifndef __geometry_msgs__msg__twist_with_covariance_stamped__struct__hpp__
#define __geometry_msgs__msg__twist_with_covariance_stamped__struct__hpp__
...
#ifndef _WIN32
# define DEPRECATED_geometry_msgs_msg_TwistWithCovarianceStamped __attribute__((deprecated))
#else
# define DEPRECATED_geometry_msgs_msg_TwistWithCovarianceStamped __declspec(deprecated)
#endif
...
struct TwistWithCovarianceStamped_
{
  ...
  template<typename Deleter = std::default_delete<geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator>>>
  ...
  typedef DEPRECATED_geometry_msgs_msg_TwistWithCovarianceStamped
    std::shared_ptr<geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_geometry_msgs_msg_TwistWithCovarianceStamped
    std::shared_ptr<geometry_msgs::msg::TwistWithCovarianceStamped_<ContainerAllocator> const>
...
#endif  // __geometry_msgs__msg__twist_with_covariance_stamped__struct__hpp__
