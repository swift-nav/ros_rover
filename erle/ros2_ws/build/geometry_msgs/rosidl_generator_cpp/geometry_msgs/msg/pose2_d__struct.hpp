...
#ifndef __geometry_msgs__msg__pose2_d__struct__hpp__
#define __geometry_msgs__msg__pose2_d__struct__hpp__
...
struct Pose2D_
{
  ...
  Type * set__theta(const double & _arg)
  {
    this->theta = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<geometry_msgs::msg::Pose2D_<ContainerAllocator>>>
...
#endif  // __geometry_msgs__msg__pose2_d__struct__hpp__
