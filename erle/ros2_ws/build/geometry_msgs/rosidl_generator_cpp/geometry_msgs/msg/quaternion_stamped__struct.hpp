...
#ifndef __geometry_msgs__msg__quaternion_stamped__struct__hpp__
#define __geometry_msgs__msg__quaternion_stamped__struct__hpp__
...
struct QuaternionStamped_
{
  ...
  Type * set__quaternion(const geometry_msgs::msg::Quaternion_<ContainerAllocator> & _arg)
  {
  ...
  template<typename Deleter = std::default_delete<geometry_msgs::msg::QuaternionStamped_<ContainerAllocator>>>
...
#endif  // __geometry_msgs__msg__quaternion_stamped__struct__hpp__
