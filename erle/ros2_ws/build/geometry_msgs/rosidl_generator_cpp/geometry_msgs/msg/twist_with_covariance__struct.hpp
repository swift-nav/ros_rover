...
#ifndef __geometry_msgs__msg__twist_with_covariance__struct__hpp__
#define __geometry_msgs__msg__twist_with_covariance__struct__hpp__
...
struct TwistWithCovariance_
{
  ...
  template<typename Deleter = std::default_delete<geometry_msgs::msg::TwistWithCovariance_<ContainerAllocator>>>
...
#endif  // __geometry_msgs__msg__twist_with_covariance__struct__hpp__
