...
#ifndef __geometry_msgs__msg__transform__struct__hpp__
#define __geometry_msgs__msg__transform__struct__hpp__
...
struct Transform_
{
  ...
  Type * set__translation(const geometry_msgs::msg::Vector3_<ContainerAllocator> & _arg)
  {
    this->translation = _arg;
    return this;
  }
  Type * set__rotation(const geometry_msgs::msg::Quaternion_<ContainerAllocator> & _arg)
  {
    this->rotation = _arg;
    return this;
  }
  ...
  template<typename Deleter = std::default_delete<geometry_msgs::msg::Transform_<ContainerAllocator>>>
...
#endif  // __geometry_msgs__msg__transform__struct__hpp__
