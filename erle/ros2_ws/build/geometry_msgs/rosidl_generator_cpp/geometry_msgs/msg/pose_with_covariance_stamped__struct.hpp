...
#ifndef __geometry_msgs__msg__pose_with_covariance_stamped__struct__hpp__
#define __geometry_msgs__msg__pose_with_covariance_stamped__struct__hpp__
...
struct PoseWithCovarianceStamped_
{
  ...
  template<typename Deleter = std::default_delete<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>>>
...
#endif  // __geometry_msgs__msg__pose_with_covariance_stamped__struct__hpp__
