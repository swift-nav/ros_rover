...
if(NOT "${_exported_dependencies} " STREQUAL " ")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(${_dep}_DEFINITIONS)
      list(APPEND example_interfaces_DEFINITIONS "${${_dep}_DEFINITIONS}")
    endif()
    if(${_dep}_INCLUDE_DIRS)
      list(APPEND example_interfaces_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
    endif()
    if(${_dep}_LIBRARIES)
      list(APPEND example_interfaces_LIBRARIES "${${_dep}_LIBRARIES}")
    endif()
