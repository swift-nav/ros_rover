...
if("TRUE" STREQUAL "TRUE")
  set(raspicam_SOURCE_PREFIX /home/erle/ros_catkin_ws/src/raspicam_node)
  set(raspicam_DEVEL_PREFIX /home/erle/ros_catkin_ws/devel_isolated/raspicam)
  set(raspicam_INSTALL_PREFIX "")
  set(raspicam_PREFIX ${raspicam_DEVEL_PREFIX})
else()
  set(raspicam_SOURCE_PREFIX "")
  set(raspicam_DEVEL_PREFIX "")
  set(raspicam_INSTALL_PREFIX /home/erle/ros_catkin_ws/install_isolated)
...
if(NOT "/home/erle/ros_catkin_ws/src/raspicam_node/include " STREQUAL " ")
  set(raspicam_INCLUDE_DIRS "")
  set(_include_dirs "/home/erle/ros_catkin_ws/src/raspicam_node/include")
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${raspicam_DIR}/../../../include" ABSOLUTE)
      ...
      message(FATAL_ERROR "Project 'raspicam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/erle/ros_catkin_ws/src/raspicam_node/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/erle/ros_catkin_ws/devel_isolated/raspicam/lib;/home/erle/ros_catkin_ws/install_isolated/lib)
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(raspicam_LIBRARIES ${raspicam_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${raspicam_dep}_LIBRARIES})
  _list_append_deduplicate(raspicam_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(raspicam_LIBRARIES ${raspicam_LIBRARIES})
