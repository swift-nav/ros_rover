...
if("TRUE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /home/erle/ros_catkin_ws/src/pluginlib)
  set(pluginlib_DEVEL_PREFIX /home/erle/ros_catkin_ws/devel_isolated/pluginlib)
  ...
  set(pluginlib_INSTALL_PREFIX /home/erle/ros_catkin_ws/install_isolated)
...
if(NOT "/home/erle/ros_catkin_ws/src/pluginlib/include;/usr/include " STREQUAL " ")
  set(pluginlib_INCLUDE_DIRS "")
  set(_include_dirs "/home/erle/ros_catkin_ws/src/pluginlib/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/erle/ros_catkin_ws/src/pluginlib/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/erle/ros_catkin_ws/devel_isolated/pluginlib/lib;/home/erle/ros_catkin_ws/install_isolated/lib)
