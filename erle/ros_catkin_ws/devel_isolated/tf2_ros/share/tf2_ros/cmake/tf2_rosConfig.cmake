...
if("TRUE" STREQUAL "TRUE")
  set(tf2_ros_SOURCE_PREFIX /home/erle/ros_catkin_ws/src/geometry_experimental/tf2_ros)
  set(tf2_ros_DEVEL_PREFIX /home/erle/ros_catkin_ws/devel_isolated/tf2_ros)
  set(tf2_ros_INSTALL_PREFIX "")
  set(tf2_ros_PREFIX ${tf2_ros_DEVEL_PREFIX})
else()
  set(tf2_ros_SOURCE_PREFIX "")
  set(tf2_ros_DEVEL_PREFIX "")
  set(tf2_ros_INSTALL_PREFIX /home/erle/ros_catkin_ws/install_isolated)
...
if(NOT "/home/erle/ros_catkin_ws/src/geometry_experimental/tf2_ros/include " STREQUAL " ")
  set(tf2_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/erle/ros_catkin_ws/src/geometry_experimental/tf2_ros/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/erle/ros_catkin_ws/src/geometry_experimental/tf2_ros/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/erle/ros_catkin_ws/devel_isolated/tf2_ros/lib;/home/erle/ros_catkin_ws/install_isolated/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tf2_ros_dep}_FOUND)
      find_package(${tf2_ros_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tf2_ros_dep} REQUIRED ${depend_list})
  endif()
