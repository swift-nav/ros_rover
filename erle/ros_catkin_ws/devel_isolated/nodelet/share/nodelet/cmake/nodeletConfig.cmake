...
if("TRUE" STREQUAL "TRUE")
  set(nodelet_SOURCE_PREFIX /home/erle/ros_catkin_ws/src/nodelet_core/nodelet)
  set(nodelet_DEVEL_PREFIX /home/erle/ros_catkin_ws/devel_isolated/nodelet)
  set(nodelet_INSTALL_PREFIX "")
  set(nodelet_PREFIX ${nodelet_DEVEL_PREFIX})
else()
  set(nodelet_SOURCE_PREFIX "")
  set(nodelet_DEVEL_PREFIX "")
  set(nodelet_INSTALL_PREFIX /home/erle/ros_catkin_ws/install_isolated)
...
if(NOT "/home/erle/ros_catkin_ws/devel_isolated/nodelet/include;/home/erle/ros_catkin_ws/src/nodelet_core/nodelet/include;/usr/include " STREQUAL " ")
  set(nodelet_INCLUDE_DIRS "")
  set(_include_dirs "/home/erle/ros_catkin_ws/devel_isolated/nodelet/include;/home/erle/ros_catkin_ws/src/nodelet_core/nodelet/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/erle/ros_catkin_ws/src/nodelet_core/nodelet/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(nodelet_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "nodeletlib;/usr/lib/arm-linux-gnueabihf/libuuid.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/erle/ros_catkin_ws/devel_isolated/nodelet/lib;/home/erle/ros_catkin_ws/install_isolated/lib)
...
set(nodelet_EXPORTED_TARGETS "nodelet_generate_messages_cpp;nodelet_generate_messages_lisp;nodelet_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${nodelet_dep}_FOUND)
      find_package(${nodelet_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${nodelet_dep} REQUIRED ${depend_list})
  endif()
