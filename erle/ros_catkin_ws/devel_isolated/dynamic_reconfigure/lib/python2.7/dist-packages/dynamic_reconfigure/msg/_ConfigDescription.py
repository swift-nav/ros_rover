    ...
    try:
      ...
      for val1 in self.groups:
        ...
        for val2 in val1.parameters:
          ...
          if python3:
            ...
            buff.write(struct.pack('<I%ss'%length, length, _x))
          buff.write(_struct_I.pack(val2.level))
          _x = val2.description
          length = len(_x)
          if python3 or type(_x) == unicode:
            _x = _x.encode('utf-8')
          ...
          if python3:
            ...
            buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1
        buff.write(_struct_2i.pack(_x.parent, _x.id))
      ...
      for val1 in self.max.bools:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_B.pack(val1.value))
      ...
      for val1 in self.max.ints:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_i.pack(val1.value))
      ...
      for val1 in self.max.groups:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1
        buff.write(_struct_B2i.pack(_x.state, _x.id, _x.parent))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (val2.level,) = _struct_I.unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
        ...
        (_x.parent, _x.id,) = _struct_2i.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (val1.value,) = _struct_B.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (val1.value,) = _struct_i.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (_x.state, _x.id, _x.parent,) = _struct_B2i.unpack(str[start:end])
