...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B2f.pack(_x.active, _x.heartbeat_timeout, _x.heartbeat_period))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.active, _x.heartbeat_timeout, _x.heartbeat_period,) = _struct_B2f.unpack(str[start:end])
