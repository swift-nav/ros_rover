...
if(NOT "include;/usr/include/eigen3;/home/erle/spider_ws/install_isolated/include;/usr/include " STREQUAL " ")
  set(kdl_parser_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/eigen3;/home/erle/spider_ws/install_isolated/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kdl_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/erle/spider_ws/install_isolated/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
